...
from ProbabilityCalculation import ProbabilityCalculation # UPDATE: to calculate probabilities
...
class Goowe(StreamModel):
    ...
    def prepare_post_analysis_req(self, num_features, num_targets, num_classes, target_values, record=False):
        ...
        ############################ UPDATE: To calculate probabilities
        self.probabilityCalculator = ProbabilityCalculation(self._num_classes)
        ############################
    ...
    def _get_components_predictions_for_instance(self, inst):
        ...
        ############################ UPDATE: To calculate probabilities
        self.probabilityCalculator.calculateProbabilities( preds )
        ############################
